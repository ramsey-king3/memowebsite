    ...
    >
      ...
      >
        <div className="flex w-full min-w-0 flex-col items-center">
          ...
          <h1
            id="dc-hero-title"
            className="m-0 w-full min-w-0 max-w-[min(100%,36rem)] text-balance sm:max-w-[44rem] md:max-w-[48rem] lg:max-w-[56rem]"
          >
            <span className="block text-[clamp(1.875rem,calc(1.25rem+3.8vw),4.125rem)] font-semibold leading-[1.05] tracking-[-0.045em] sm:leading-[1.02]">
              When uptime is on the line, radio traffic holds the first signals.
            </span>
