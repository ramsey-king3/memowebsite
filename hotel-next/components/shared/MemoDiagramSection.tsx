type Props = {
  ...
  src: string;
  alt: string;
  /** Overrides default section aria-label (e.g. vertical-specific wording). */
...
export function MemoDiagramSection({ variant, src, alt, sectionAriaLabel }: Props) {
  return (
    <section
      className="w-full"
      aria-label={sectionAriaLabel ?? defaultSectionAria[variant]}
    >
